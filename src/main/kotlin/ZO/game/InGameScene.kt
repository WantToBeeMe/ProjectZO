...
class InGameScene : IScene() {
    ...
    init {
        ...
        controller.addSingleton(GridSettings().setGrid(17, 10).setScale(0.6f).setBorderWidthPercentage(0.3f).setViewBox(viewBox.first, viewBox.second).setLocKYaxis(true))
